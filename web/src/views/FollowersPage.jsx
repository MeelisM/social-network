    ...
    return (
        <MainLayout>
            <Box sx={{ padding: 4, maxWidth: "1400px", margin: "0 auto" }}>
                ...
                <FollowRequests followRequests={followRequests} setFollowRequests={setFollowRequests} setFollowers={setFollowers} />
                <Typography variant="h5" sx={{ color: "white", fontWeight: "bold", marginBottom: 4 }}>
                    Followers
                </Typography>
                <FollowList data={followers} emptyMessage="You have no followers yet." />
                <Typography variant="h5" sx={{ color: "white", fontWeight: "bold", marginBottom: 4 }}>
                    Following
                </Typography>
                <FollowList data={following} emptyMessage="You are not following anyone yet." />
            </Box>
        </MainLayout>
    );
}
